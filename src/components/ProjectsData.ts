export const projectsList = [
    {
        'id': 1,
        'name': 'chitchat(MERN)',
        'img': 'https://github.com/abhinav3254/chitchat/raw/master/Screenshot%202024-06-11%20at%2023.01.14.png',
        'link': 'https://github.com/abhinav3254/chitchat',
        'tech': ['React.js', 'Node.js', 'Express.js', 'JWT', 'Websocket', 'Typescript', 'MongoDB'],
    ...
    {
        'id': 2,
        'name': 'dictionary(Angular)',
        'img': 'https://placehold.co/600x400',
        'link': 'https://github.com/abhinav3254/dictionary',
        'tech': ['Angular16', 'API', 'Typescript'],
        'desc': 'This Real-Time Chat Application is designed to facilitate instant messaging between users with real-time updates. Leveraging a modern tech stack, the application ensures a seamless and responsive user experience.'
    },
    {
        'id': 3,
        ...
        'img': 'https://placehold.co/600x400',
        'link': 'https://github.com/abhinav3254/Blogify',
        'tech': ['Java 11', 'Spring 2.0.17', 'Eureka Server', 'API Gateway', 'MySQL'],
        'desc': 'This Real-Time Chat Application is designed to facilitate instant messaging between users with real-time updates. Leveraging a modern tech stack, the application ensures a seamless and responsive user experience.'
    },
    {
        'id': 4,
