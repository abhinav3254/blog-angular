        ...
        <div className='flex flex-col items-center justify-center pt-[0px]'>
            <div className='flex flex-wrap gap-3 p-5 items-center justify-center'>
                {SkillsList.map((data, key) => (
                    <div className='w-36 h-36 border flex flex-col justify-center items-center rounded-md p-5 cursor-pointer hover:shadow-md transition-all text-center' key={key}>
